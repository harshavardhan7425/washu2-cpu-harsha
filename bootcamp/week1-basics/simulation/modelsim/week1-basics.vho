...
-- en	=>  Location: PIN_P4,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- sel	=>  Location: PIN_P1,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF mux2_en IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \y~0_combout\ = (\en~input_o\ & ((\sel~input_o\ & ((\b~input_o\))) # (!\sel~input_o\ & (\a~input_o\))))
